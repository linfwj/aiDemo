...
.vxe-header--column.fixed--width > .vxe-cell .vxe-number-input,
.vxe-header--column.fixed--width > .vxe-cell .vxe-ico-picker,
.vxe-footer--column.fixed--width > .vxe-cell .vxe-input,
.vxe-footer--column.fixed--width > .vxe-cell .vxe-textarea,
.vxe-footer--column.fixed--width > .vxe-cell .vxe-select,
.vxe-footer--column.fixed--width > .vxe-cell .vxe-tree-select,
.vxe-footer--column.fixed--width > .vxe-cell .vxe-date-picker,
.vxe-footer--column.fixed--width > .vxe-cell .vxe-number-input,
...
.vxe-body--column.fixed--width > .vxe-cell > .vxe-cell--tree-node .vxe-tree-select,
.vxe-body--column.fixed--width > .vxe-cell > .vxe-cell--tree-node .vxe-date-picker,
.vxe-body--column.fixed--width > .vxe-cell > .vxe-cell--tree-node .vxe-number-input,
.vxe-body--column.fixed--width > .vxe-cell > .vxe-cell--tree-node .vxe-ico-picker {
  width: 100%;
}
...
.vxe-table--render-default .vxe-table--resizable-bar .vxe-table--resizable-number-tip {
  position: absolute;
  left: 0;
  top: 1em;
