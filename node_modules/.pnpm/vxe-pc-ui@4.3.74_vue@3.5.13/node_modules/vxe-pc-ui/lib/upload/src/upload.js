  ...
  setup(props, context) {
    ...
    const renderFileAction = isMoreView => {
      ...
      return (0, _vue.h)('div', {
        ...
        disabled: isDisabled
      })]), isMoreView && (defHintText || tipSlot) ? (0, _vue.h)('div', {
    ...
    const renderAllMode = () => {
      ...
      }, [showMoreButton && moreConfig && isHorizontal ? (0, _vue.createCommentVNode)() : renderFileAction(true), currList.length || showMoreButton && isHorizontal ? (0, _vue.h)('div', {
      ...
      })]) : (0, _vue.createCommentVNode)(), showMoreButton && moreConfig && isHorizontal ? renderFileAction(false) : (0, _vue.createCommentVNode)()]) : (0, _vue.createCommentVNode)()]);
    };
    ...
    const renderImageAction = isMoreView => {
      ...
      }, buttonText ? `${buttonText}` : (0, _ui.getI18n)('vxe.upload.imgBtnText')) : (0, _vue.createCommentVNode)(), isMoreView && (defHintText || hintSlot) ? (0, _vue.h)('div', {
    ...
    const renderImageMode = () => {
      ...
      }, [dragSort ? (0, _vue.h)(_vue.TransitionGroup, {
        name: `vxe-upload--drag-list${isDragMove ? '' : '-disabled'}`,
        tag: 'div',
