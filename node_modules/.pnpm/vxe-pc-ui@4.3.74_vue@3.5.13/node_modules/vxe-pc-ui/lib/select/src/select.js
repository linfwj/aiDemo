  ...
  setup(props, context) {
    ...
    const renderOption = (list, group) => {
      ...
      return list.map((option, cIndex) => {
        ...
        }, optionSlot ? callSlot(optionSlot, optParams) : defaultSlot ? callSlot(defaultSlot, optParams) : (0, _utils.getFuncText)(option[isOptGroup ? groupLabelField : labelField])) : (0, _vue.createCommentVNode)();
      });
    };
    const renderOpts = () => {
      const {
    ...
    const renderVN = () => {
      ...
      })]) : (0, _vue.createCommentVNode)(), headerSlot ? (0, _vue.h)('div', {
